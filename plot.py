...
# Load the data
file_no_extra = "timing_data_nostress.csv"
file_extra = "timing_data_stress.csv"
...
plt.plot(df_no_extra["Iteration"], df_no_extra["Elapsed Time (ms)"], 'bo-', markersize=3, alpha=0.7, label="Without Extra Load")
plt.plot(df_extra["Iteration"], df_extra["Elapsed Time (ms)"], 'rx-', markersize=3, alpha=0.7, label="With Extra Load")
